...
const LABELS: Record<string, string> = {
	...
	research_report_word_target: 'Report Word Target',
	research_synthesis_excerpt_chars: 'Synthesis Excerpt Chars',
	...
	llm_thinking_enabled: 'DeepSeek Thinking Mode',
	llm_thinking_effort: 'DeepSeek Thinking Effort',
