...
def test_finding_crud():
    ...
    res = requests.post(f"{BASE_URL}/research/{research_id}/findings", json=finding_data)
    ...
    res = requests.post(f"{BASE_URL}/research/{research_id}/findings", json=finding_data2)
    
    if res.status_code != 201:
        print(f"❌ Failed to create finding with source: {res.status_code} - {res.text}")
        return False
    ...
    res = requests.patch(f"{BASE_URL}/research/{research_id}/findings/{finding_id}", json=update_data)
    ...
    res = requests.patch(f"{BASE_URL}/research/{research_id}/findings/{finding_id}", json=update_data2)
    
    if res.status_code != 200:
        print(f"❌ Failed to update finding sources: {res.status_code} - {res.text}")
        return False
    ...
    res = requests.delete(f"{BASE_URL}/research/{research_id}/findings/{finding_id}")
    ...
    res = requests.delete(f"{BASE_URL}/research/{research_id}/findings/{finding2_id}")
